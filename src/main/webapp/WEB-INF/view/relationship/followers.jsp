    ...
    <div class="row">
        <aside class="col-md-4">
            <section class="user_info">
                <img alt="招贤纳士" class="gravatar" src="${userInfo.face}" />
            ...
            <section class="stats">
                ...
                <div class="user_avatars">
                    <c:forEach items="${userInfo.fans}" var="r">
                        <a href="/user/${r.user.userid}/findUser">
                            <img alt="${r.user.username}" class="gravatar" style="width: 30px; height: 30px;" src="${r.user.face}" />
                        </a>
                    </c:forEach>
                </div>
            </section>
            ...
            <ul class="users follow">
                <c:forEach items="${userInfo.fans}" var="r">
                    <li style="list-style-type:none;">
                        <img alt="${r.user.username}" class="gravatar" src="${r.user.face}" />
                        <a href="/user/${r.user.userid}/findUser">${r.user.username}</a>
                    </li>
                </c:forEach>
            </ul>
